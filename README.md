...
```
C:\Users\%USERNAME%\RStudio-2026.08.2-200\resources\app\bin\quarto\bin\tools
```
...
```
C:\Users\%USERNAME%\RStudio-2026.08.2-200\resources\app\bin\quarto\bin
```
