...
``` batchfile
C:\Users\%USERNAME%\RStudio-2025.09.2-418\resources\app\bin\quarto\bin\tools
```
...
``` batchfile
C:\Users\%USERNAME%\RStudio-2025.09.2-418\resources\app\bin\quarto\bin
```
