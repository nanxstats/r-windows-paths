...
``` batchfile
C:\Users\%USERNAME%\RStudio-2026.05.0-218\resources\app\bin\quarto\bin\tools
```
...
``` batchfile
C:\Users\%USERNAME%\RStudio-2026.05.0-218\resources\app\bin\quarto\bin
```
