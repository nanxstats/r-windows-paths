...
``` batchfile
C:\Users\%USERNAME%\RStudio-2026.04.0-526\resources\app\bin\quarto\bin\tools
```
...
``` batchfile
C:\Users\%USERNAME%\RStudio-2026.04.0-526\resources\app\bin\quarto\bin
```
