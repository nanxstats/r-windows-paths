...
``` batchfile
C:\Users\%USERNAME%\RStudio-2026.01.0-392\resources\app\bin\quarto\bin\tools
```
...
``` batchfile
C:\Users\%USERNAME%\RStudio-2026.01.0-392\resources\app\bin\quarto\bin
```
