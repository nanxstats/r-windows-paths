...
``` batchfile
C:\Users\%USERNAME%\RStudio-2026.01.2-418\resources\app\bin\quarto\bin\tools
```
...
``` batchfile
C:\Users\%USERNAME%\RStudio-2026.01.2-418\resources\app\bin\quarto\bin
```
