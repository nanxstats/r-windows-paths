...
```
C:\Users\%USERNAME%\RStudio-2026.08.1-195\resources\app\bin\quarto\bin\tools
```
...
```
C:\Users\%USERNAME%\RStudio-2026.08.1-195\resources\app\bin\quarto\bin
```
