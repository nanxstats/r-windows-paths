...
```
C:\Users\%USERNAME%\RStudio-2026.08.0-187\resources\app\bin\quarto\bin\tools
```
...
```
C:\Users\%USERNAME%\RStudio-2026.08.0-187\resources\app\bin\quarto\bin
```
