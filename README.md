...
```
C:\Users\%USERNAME%\RStudio-2026.09.0-174\resources\app\bin\quarto\bin\tools
```
...
```
C:\Users\%USERNAME%\RStudio-2026.09.0-174\resources\app\bin\quarto\bin
```
